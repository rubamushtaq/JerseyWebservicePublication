...
public class Adages {
	...
	public JAXBElement<Adage>  getXml() {
		...
		adage.setWords("I am Adage");
		adage.setWordCount(12);
		AdageCustomer aCust=new AdageCustomer();
		aCust.setAdageCustName("I am Adage Customer");
		adage.setaCust(aCust);
		return toXml(adage);
	}
	...
	private JAXBElement<Adage> toXml(Adage adage) {
		return new JAXBElement<Adage>(new QName("adage"), Adage.class, adage); // that is equivalent to @xmlRoot elemenet
	}
